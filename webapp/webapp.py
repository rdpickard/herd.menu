...
# RESTful API
class LookupInstances(Resource):
    def get(self):
        return {'hello lookup': 'world'}


class SearchInstances(Resource):
    def get(self):
        return {'hello search': 'world'}


api.add_resource(LookupInstances, '/api/lookup')
api.add_resource(SearchInstances, '/api/search')
